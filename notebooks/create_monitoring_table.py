...
# MAGIC %pip install /Workspace/Users/subhadip18@gmail.com/.bundle/dev/marvelous-databricks-course-subhadip18/artifacts/.internal/hotel_reservation-0.0.1-py3-none-any.whl --force-reinstall
...
import yaml
import logging
from pyspark.sql.functions import to_utc_timestamp, current_timestamp,monotonically_increasing_id
...
model_uri = f"models:/mlops_dev.subhadip.hotel_reservation_model_basic@latest-model"
...
def send_request_workspace(dataframe_record):
    response = workspace.serving_endpoints.query(
        name="hotel_reservation_model-serving",
